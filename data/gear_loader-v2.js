...
// Example:
console.log(parseGearId(12102));
// { color: 'White', stars: 2, type: 'Weapon', faction: 'No Faction', class: 'Agility' }

console.log(parseGearId(54323));
// { color: 'Orange', stars: 3, type: 'Shoes', faction: 'Shadow', class: 'Strength' }

window.addEventListener("DOMContentLoaded", () => {
  const tbody = document.querySelector("#gear-table tbody");

  gear_basic.forEach(item => {
